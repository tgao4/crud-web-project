			...
			<table>
				<tbody>
					<tr>
						...
						<td><form:input path="shortDescription" placeholder="less than 200 characters"/></td>
					</tr>
				
					<tr>
						<td><label>Detail Description:</label></td>
						<td><form:input path="detailDescription" placeholder="less than 800 characters" /></td>
					</tr>
